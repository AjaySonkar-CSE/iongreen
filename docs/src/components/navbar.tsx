...
export function Navbar() {
  ...
  const handleMouseLeave = () => {
    ...
    timeoutRef.current = setTimeout(() => {
      setActiveDropdown(null);
      setIsHovered(null);
    }, 200) as unknown as NodeJS.Timeout; // Type assertion to handle ref assignment
  };
                ...
                >
                  <Link
                    ...
                    onClick={(e) => {
                      ...
                      // If it has dropdown items, allow navigation but don't prevent dropdown
                      // The dropdown will show on hover, and clicking the link will navigate
                    }}
                  >
                    {item.label}
                  </Link>
